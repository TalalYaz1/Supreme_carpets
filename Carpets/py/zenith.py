...
TARGET_URL = "https://www.cormarcarpets.co.uk/carpet-ranges/easy-clean/zenith/"
...
# Save to JSON
with open("zenith_carpets.json", "w") as f:
    json.dump(carpets, f, indent=2)

print(f"✅ Total carpets scraped: {len(carpets)} and saved to zenith_carpets.json")