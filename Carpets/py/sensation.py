...
TARGET_URL = "https://www.cormarcarpets.co.uk/carpet-ranges/soft-deep-pile/sensation/"
...
# Optional: shared description (if any)
desc_text = ""
...
# Save to JSON
with open("sensation_carpets.json", "w") as f:
    json.dump(carpets, f, indent=2)

print(f"✅ Total carpets scraped: {len(carpets)} and saved to sensation_carpets.json")